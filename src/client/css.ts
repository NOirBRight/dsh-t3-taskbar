...
.dsht3-card { flex:1; min-width:0; min-height:4.875rem; display:flex; flex-direction:column; justify-content:center; gap:2px; padding:6px 8px; border:0; border-radius:8px; background:transparent; color:var(--dsw-alias-label-primary); cursor:pointer; text-align:left; }
.dsht3-pin, .dsht3-act, .dsht3-unsettle { flex:none; border:0; background:transparent; color:var(--dsw-alias-label-tertiary); cursor:pointer; font:var(--dsw-font-xxs-12); padding:4px 6px; margin:6px 0; border-radius:6px; }
.dsht3-pin:hover, .dsht3-act:hover, .dsht3-unsettle:hover { background:var(--dsw-alias-interactive-bg-hover); color:var(--dsw-alias-label-primary); }
